...
func newMessageFromProto(pbm pb.Message) (BitSwapMessage, error) {
	...
	for _, d := range pbm.Blocks {
		...
		//println("pbm.Blocks-NewBlock--AddBlock")
		b := blocks.NewBlock(d)
		m.AddBlock(b)
	}
	//
	...
	for _, b := range pbm.GetPayload() {
		//println("pbm.GetPayload-----b.GetPrefix()",string(b.GetPrefix()))
		//println("pbm.GetPayload--Zlib---b.GetPrefix()",string(Zlib_decompress(b.GetPrefix())))
		pref, err := cid.PrefixFromBytes(b.GetPrefix())
		if err != nil {
			return nil, err
		}
		//println("pbm.GetPayload-----pref.Sum--b.GetData()",string(b.GetData()))
		...
		//println("pbm.GetPayload-----NewBlockWithCid,zlib --b.GetData",string(Zlib_decompress(b.GetData())))
		blk, err := blocks.NewBlockWithCid1(data, c)
		if err != nil {
			return nil, err
		}
